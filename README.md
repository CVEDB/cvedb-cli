...
<h3 align="center">
Execute <a href=https://cvedb.khulnasoft.com>Cvedb</a> workflows right from your terminal.
</h3>
<br>
...
[Cvedb Library](https://cvedb.khulnasoft.com/dashboard/library) is a collection of public tools, Cvedb scripts, and Cvedb workflows available on the platform. More info can be found at [Cvedb workflows repository](https://github.com/cvedb/workflows) <- (Coming soon!)
...
You can find your authentication token on the [Token](https://cvedb.khulnasoft.com/dashboard/settings/token) page inside the Cvedb platform.
...
Use the **library** command to get more info about Cvedb workflows and public tools available in the [Cvedb Library](https://cvedb.khulnasoft.com/dashboard/library).

#### List
Use **library list** command to list all public tools & workflows available in the [library](https://cvedb.khulnasoft.com/dashboard/library), along with their descriptions.
...
#### Search
Use **library search** to search all Cvedb tools & workflows available in the [library](https://cvedb.khulnasoft.com/dashboard/library), along with their descriptions.
...
## Tools command
Manage [private tools](https://cvedb.khulnasoft.com/docs/tutorials/private-tools/private-tools-library/)

⚒️ Learn how to add your first tool integration [here](https://cvedb.khulnasoft.com/docs/tutorials/private-tools/dockerfile-and-cvedb-yaml/).
...
We look forward to any feedback you want to share with us or if you're stuck with a problem you can contact us at [support@khulnasoft.com](mailto:support@khulnasoft.com).
