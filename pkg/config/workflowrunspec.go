...
type WorkflowRunSpec struct {
	...
	// Resolved objects
	Space   *cvedb.Space
	Project *cvedb.Project
}

// GetRuns retrieves runs based on the specification
func (s WorkflowRunSpec) GetRuns(ctx context.Context, client *cvedb.Client) ([]cvedb.Run, error) {
...
func (s WorkflowRunSpec) GetWorkflow(ctx context.Context, client *cvedb.Client) (*cvedb.Workflow, error) {
...
func (s *WorkflowRunSpec) CreateMissing(ctx context.Context, client *cvedb.Client) error {
	if s.SpaceName == "" {
...
func (s *WorkflowRunSpec) ResolveSpaceAndProject(ctx context.Context, client *cvedb.Client) error {
	if s.Space == nil {
...
func (s WorkflowRunSpec) resolveSingleRun(ctx context.Context, client *cvedb.Client) (*cvedb.Run, error) {
	if s.RunID != "" {
