...
type WorkflowInput interface {
	ApplyToWorkflowVersion(wfVersion *cvedb.WorkflowVersion) error
}
...
func (input PrimitiveNodeInput) ApplyToWorkflowVersion(wfVersion *cvedb.WorkflowVersion) error {
	if wfVersion == nil {
...
func (input NodeInput) ApplyToWorkflowVersion(wfVersion *cvedb.WorkflowVersion) error {
	if wfVersion == nil {
		return fmt.Errorf("workflow version is nil")
	}
