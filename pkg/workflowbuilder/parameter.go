...
//	    }
//	}
func updatePrimitiveNodeReferences(wfVersion *cvedb.WorkflowVersion, pNode *cvedb.PrimitiveNode) error {
...
func addNodeInputPrimitiveReference(node *cvedb.Node, pNode *cvedb.PrimitiveNode, inputName string) error {
	...
	node.Inputs[inputKey] = &cvedb.NodeInput{
...
func removeNodeInputPrimitiveReference(wfVersion *cvedb.WorkflowVersion, nodeID string, pNodeID string, inputName string) error {
	if wfVersion == nil {
...
func setupNodeParam(wfVersion *cvedb.WorkflowVersion, nodeID string, paramName string, paramType string, value any) error {
	if wfVersion == nil {
		return fmt.Errorf("workflow version is nil")
	}
...
func cleanupNodeParam(wfVersion *cvedb.WorkflowVersion, nodeID string, paramName string) error {
	if wfVersion == nil {
		return fmt.Errorf("workflow version is nil")
	}
