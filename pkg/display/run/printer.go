...
type TreeNode struct {
	Name         string
	Label        string
	Inputs       *map[string]*cvedb.NodeInput
	Status       string
	OutputStatus string
...
func (p *RunPrinter) PrintAll(run *cvedb.Run, subJobs []cvedb.SubJob, version *cvedb.WorkflowVersion, includeTaskGroupStats bool) {
...
func formatMachines(machines cvedb.Machines) string {
...
func (p *RunPrinter) formatSubJobTree(subJobs []cvedb.SubJob, version *cvedb.WorkflowVersion, defaultSubJobStatus string, includeTaskGroupStats bool) string {
...
func (p *RunPrinter) createTrees(subJobs []cvedb.SubJob, wfVersion *cvedb.WorkflowVersion, defaultSubJobStatus string, includeTaskGroupStats bool) (map[string]*TreeNode, []*TreeNode) {
